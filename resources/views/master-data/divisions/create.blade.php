...
<div class="max-w-4xl mx-auto">
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Create New Division</h1>
            <p class="text-gray-500 mt-1 text-sm">Add a new organizational division.</p>
        </div>
    ...
    <div class="bg-white border border-gray-200/50 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="p-8">
            <form action="{{ route('master-data.divisions.store') }}" method="POST" class="space-y-6">
                @csrf

                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-1.5">Name <span class="text-red-600">*</span></label>
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. IT, Finance, HR"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" placeholder="Brief description of the division..."
